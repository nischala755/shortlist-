  ...
  return (
    <div className="workspace-shell">
      <aside className="workspace-sidebar">
        ...
        <nav aria-label="Workspace navigation"><Link className="active" href={`/dashboard/organizations/${organizationId}`}><span aria-hidden="true">▦</span>Jobs</Link><Link href="/dashboard"><span aria-hidden="true">←</span>All organizations</Link></nav>
